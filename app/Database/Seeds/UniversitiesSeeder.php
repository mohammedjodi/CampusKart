...
class UniversitiesSeeder extends Seeder
{
    public function run()
    {
        ...
        */
        ...
        //get the state id for each university and insert into the Campuses table with the state_id foreign key
        foreach($universities as $stateName => $university) {
            $state = $this->db->table('states')
                                ->where('name', $stateName)
                                ->get()
                                ->getRow();
                                
            //insert each university into the Campuses table with the state_id foreign key
